...
('nu5fe23e83aea3467', 'nuFilesVersion', 'V.4.5-2021.07.06.03'),
('nu5fe23e83aea3466', 'nuDBVersion', 'V.4.5-2021.07.06.00');
...
('nu5bad6cb32c4d9de', 'nuobject', 'zzzzsys_object', 'select', 'sob_input_type', 'Input Type (and class)', 'nu5bad6cb36a4af06', 670, 50, 239, 161, 22, '1', 'left', '0', '0', '1', '', '', '', '', '', NULL, NULL, '', '', '0', '0', 'nuDate|nuDate|\nnuNumber|nuNumber|\nnuScroll|nuScroll|\nnuAutoNumber|nuAutoNumber|\nbutton|Button|\ncheckbox|Checkbox|\ncolor|Color|\ndatetime-local|Datetime-Local|\nemail|Email|\nfile|File|\nhidden|Hidden|\nimage|Image|\nmonth|Month|\nnumber|Number|\npassword|Password|\nradio|Radio|\nrange|Range|\nreset|Reset|\nsearch|Search|\ntel|Telephone|\ntext|Text|\ntime|Time|\nurl|URL|\nweek|Week\n\n\n', 'syt_title', 'sfo_description', '200', '0', 'nutab', '', '', 'zzzzsys_tab', '', '', '', '', '', '', 0, '', 'text', '', NULL, '', '', '', '', '', '', ''),
('nu5bad6cb32c708be', 'nuobject', 'zzzzsys_object', 'select', 'sob_input_format', 'Format', 'nu5bad6cb36a4af06', 650, 77, 239, 161, 22, '1', 'right', '0', '0', '0', '', '', '', '', '', NULL, NULL, '', '', '0', '0', 'SELECT \n   CONCAT(LEFT(srm_type, 1), \'|\', TRIM(srm_format)) AS a, \n   srm_format AS b \nFROM zzzzsys_format\nORDER BY srm_type\n', 'syt_title', 'sfo_description', '200', '0', 'nutab', '', '', 'zzzzsys_tab', '', '', '', '', '', '', 0, '', 'text', '', NULL, '', '', '', '', '', '', ''),
...
('nu5bad6cb34feb6d2', 'nuobject', 'zzzzsys_object', 'input', 'sob_input_javascript', 'JavaScript Array', 'nu5bad6cb36a4af06', 680, 77, 239, 436, 22, '1', 'left', '0', '0', '0', '', '', '', '', '', NULL, NULL, '', '', '0', '0', '0|No|1|Yes', 'syt_title', 'sfo_description', '200', '', 'nutab', '', '', 'zzzzsys_tab', '', '', '', '', '', '', 0, '', 'text', '', NULL, '', '', '', '', '', '', ''),
...
('nu5bad6cb356dfe23', 'nuobject', 'zzzzsys_object', 'input', 'sob_input_count', 'Next Number', 'nu5bad6cb36a4af06', 660, 77, 239, 50, 22, '1', 'right', '0', '0', '0', '', '', '', '', '', NULL, NULL, '', '', '0', '0', 'SELECT \n   CONCAT(LEFT(srm_type, 1), \'|\', TRIM(srm_format)) AS a, \n   srm_format AS b \nFROM zzzzsys_format\nORDER BY srm_type\n', 'syt_title', 'sfo_description', '200', '', 'nutab', '', '', 'zzzzsys_tab', '', '', '', '', '', '', 0, '', 'number', '', NULL, '', '', '', '', '', '', ''),
...
('nu60085a561599dfd', 'nuobject', 'zzzzsys_object', 'textarea', 'sob_input_datalist', 'Datalist', 'nu5bad6cb36a4af06', 690, 104, 239, 436, 60, '1', 'left', '0', '0', '0', '', '', '', '', '', NULL, NULL, '', '', '0', '0', '0|No|1|Yes', 'syt_title', 'sfo_description', '200', NULL, 'nutab', '', NULL, 'zzzzsys_tab', '', '', '', '', '', '', 0, '', 'text', '', NULL, '', '', '', '', '', '', ''),
