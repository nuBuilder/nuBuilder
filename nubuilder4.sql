...
('nu5fe23e83aea3467', 'nuFilesVersion', 'V.4.5-2021.08.09.02'),
('nu5fe23e83aea3466', 'nuDBVersion', 'V.4.5-2021.08.09.00');
...
('nu610fd4ba4e73ede', 'nuupdateobject', 'Update an Object\'s Properties', 'nubuilder', '$id = \"#nuupdateobject_id#\";\n$value = \"#nuupdateobject_value#\";\n$form = \"#nuupdateobject_form_id#\";\n$column = \"#nuupdateobject_column#\";\n\n$q = \"\n    UPDATE `zzzzsys_object` \n    SET $column = ?\n    WHERE `sob_all_zzzzsys_form_id` = ? AND `sob_all_id` = ?\n\";\n\nnuRunQuery($q, array($value, $form, $id));', 'hide', NULL, '1', '0', '');
