...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 23, 2021 at 01:29 PM
...
('60510d8a0a1478a', '60510d8a0496fd5', 'onclick', 'nu2FASendToken();');
...
('nu5fe23e83aea3467', 'nuFilesVersion', 'V.4.5-2021.03.23.00'),
('nu5fe23e83aea3466', 'nuDBVersion', 'V.4.5-2021.03.23.00');
...
('6058b68e8111857', 'nuauthentication', '', 'html', 'lab01', ' ', 'nu5fe0547b76e25d6', 30, 42, 74, 1000, 20, '1', 'left', '0', '1', '', '', '', '', '', '', '', '0', '0', '', '', '', '', NULL, '', '', NULL, '', '', '', '', '', '', '', 0, '', 'text', '', '', '<div id=\'authlabel\' style=\'text-align:left; font-size:14px; \'>\n    \n<b>2 Factor Authentication</b><br><br>\nClick \'Send token\' to send an email containing a security code to the registered email address for this account.<br>Please check  in spam/junk mail.\n<br><br>The verified token will be remembered on this device for 7 days. \n			\n</div>	', '', '', '', '', '', ''),
('60510d8a0496fd5', 'nuauthentication', '', 'input', 'send_token_btn', 'Send token', 'nu5fe0547b76e25d6', 50, 197, 74, 117, 23, '1', 'center', '0', '0', '', '', '', '', '', '', '', '0', '0', '', '', '', '', NULL, '', '', NULL, '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', 'button', '', '', '', '', '', '', '', '', '');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `zzzzsys_object_list`  AS  select `information_schema`.`tables`.`TABLE_NAME` AS `zzzzsys_object_list_id` from `information_schema`.`tables` where `information_schema`.`tables`.`TABLE_SCHEMA` = database() ;
