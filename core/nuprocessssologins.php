...
function ssoGetloginRequestData() {
...
function ssoCheckloginDataAgainstDb($sso_d) {
...
function ssoMarkRowInDbAsProcessed($sso_d) {
...
function ssoVeryFirstLogin($sus_login_name) {
...
function ssoAddSysUserEntryForFirstLogin($emailLocalPart, $ssodb_d) {  // $ssodb_d["email"] and $ssodb_d["name"]
...
function ssoCheckSysUserEntryIsInOrder($sus_login_name) {
