...
function nuAlterSystemTables(){
	...
	if(array_search('set_languages_included', $setupColumns) == false){
		...
		nuRunQuery('UPDATE `zzzzsys_setup` SET set_languages_included = ?', array('["Arabic","Armenian","Chinese","Czech","French","German","Greek","Hindi","Italian","Malay","Polish","Portuguese","Romanian","Russian","Spanish","Tamil","Vietnamese"]'));
	}
