...
function nuAlterSystemTables(){
	...
	if(array_search('set_languages_included', $setupColumns) == false){
		...
		nuRunQuery('UPDATE `zzzzsys_setup` SET set_languages_included = ?', array('["Afrikaans","Arabic","Armenian","Catalan","Chinese","Czech","Danish","French","German","Greek","Hindi","Italian","Malay","Polish","Portuguese","Romanian","Russian","Slovak","Spanish","Tamil","Vietnamese"]'));
	}
